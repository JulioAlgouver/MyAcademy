...
namespace MyAcademy
{
    public partial class F_GridHorariosOnFormViewProfessor : Form
    {
        public static int idHorarioSelecionado;
        public static string descricaoHorarioSelecionado;

        F_ViewProfissional FormViewProfissional;
        public F_GridHorariosOnFormViewProfessor(F_ViewProfissional viewProfissional)
        {
            InitializeComponent();

            FormViewProfissional = viewProfissional;
        }

        private void F_GridHorariosOnFormViewProfessor_Load(object sender, EventArgs e)
        {
        ...
        private void gridHorarios_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (gridView.SelectedRows.Count > contLinhas)
            {
                ...
                FormViewProfissional.tbox_idHorario.Text = idHorarioSelecionado.ToString();
                FormViewProfissional.tbox_horario.Text = descricaoHorarioSelecionado;
